...
/************************************************
 MD5 锟姐法锟斤拷Java/JSP Bean
 JAVA/JSP MD5 Author: www.web745.com
 JAVA/JSP MD5 javabean 为锟斤拷逊锟斤拷锟斤拷锟斤拷锟阶拷锟斤拷氡ｏ拷锟皆拷锟斤拷锟斤拷锟较拷锟叫恍?
 Last Modified:10,Mar,2001
 *************************************************/
import java.lang.reflect.Array;

/*************************************************
 md5 锟斤拷实锟斤拷锟斤拷RSA Data Security, Inc.锟斤拷锟结交锟斤拷IETF
 锟斤拷RFC1321锟叫碉拷MD5 message-digest 锟姐法锟斤拷
 *************************************************/

public class MD5 {
	/* 锟斤拷锟斤拷锟斤拷些S11-S44实锟斤拷锟斤拷锟斤拷一锟斤拷4*4锟侥撅拷锟斤拷锟斤拷原始锟斤拷C实锟斤拷锟斤拷锟斤拷锟斤拷#define 实锟街的ｏ拷
	 锟斤拷锟斤拷锟斤拷锟斤拷锟绞碉拷殖锟轿猻tatic final锟角憋拷示锟斤拷只锟絚锟斤拷锟斤拷锟斤拷锟酵伙拷锟斤拷炭占锟斤拷诘亩锟斤拷
	 Instance锟戒共锟斤拷*/
	...
	/* 锟斤拷锟斤拷锟斤拷锟斤拷锟皆憋拷锟組D5锟斤拷锟斤拷锟斤拷锟斤拷锟矫碉拷锟斤拷3锟斤拷锟斤拷锟斤拷锟捷ｏ拷锟斤拷原始锟斤拷C实锟斤拷锟斤拷
	...
	/*
	 ...
	 锟斤拷锟截碉拷锟角变换锟斤拷慕锟斤拷锟斤拷锟斤拷锟斤拷谴庸锟斤拷锟斤拷锟皆眃igestHexStr取锟矫的ｏ拷
	 */
	...
	/* F, G, H ,I 锟斤拷4锟斤拷锟斤拷MD5锟斤拷锟斤拷锟斤拷原始锟斤拷MD5锟斤拷C实锟斤拷锟叫ｏ拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷
	 ...
	 实锟街筹拷锟斤拷private锟斤拷锟斤拷锟斤拷锟斤拷锟街憋拷锟斤拷锟斤拷原4C锟叫的★拷 */
	...
	/*
	 md5Update锟斤拷MD5锟斤拷锟斤拷锟斤拷锟斤拷蹋锟絠nbuf锟斤拷要锟戒换锟斤拷锟街节达拷锟斤拷inputlen锟角筹拷锟饺ｏ拷锟斤拷锟?
	...
	/*Encode锟斤拷long锟斤拷锟介按顺锟斤拷锟斤拷byte锟斤拷锟介，锟斤拷为java锟斤拷long锟斤拷锟斤拷锟斤拷64bit锟侥ｏ拷
	 只锟斤拷锟?2bit锟斤拷锟斤拷锟斤拷应原始C实锟街碉拷锟斤拷途
	 */
	...
	/*
	 b2iu锟斤拷锟斤拷写锟斤拷一锟斤拷锟絙yte锟斤拷锟秸诧拷锟斤拷锟斤拷锟斤拷诺锟皆拷锟侥ｏ拷锟斤拷位锟斤拷锟斤拷锟斤拷锟斤拷为java没锟斤拷unsigned锟斤拷锟斤拷
	 */
	public static long b2iu(byte b) {
		return b < 0 ? b & 0x7F + 128 : b;
	}

	/*byteHEX()锟斤拷锟斤拷4锟斤拷一锟斤拷byte锟斤拷锟酵碉拷锟斤拷转锟斤拷锟斤拷十锟斤拷锟斤拷频锟紸SCII锟斤拷示锟斤拷
	 锟斤拷为java锟叫碉拷byte锟斤拷toString锟睫凤拷实锟斤拷锟斤拷一锟姐，锟斤拷锟斤拷锟斤拷没锟斤拷C锟斤拷锟斤拷锟叫碉拷
...
//				'B', 'C', 'D', 'E', 'F' };
	...
	public static void main(String args[]) {
		...
		MD5 m = new MD5();
		if (Array.getLength(args) == 0) { //锟斤拷锟矫伙拷胁锟斤拷锟街达拷斜锟阶硷拷锟絋est Suite
